            ...
            <div className='activity-log-modal__body'>
                <p className='session-help-text'>
                    <FormattedMessage
                        ...
                        defaultMessage="Sessions are created when you log in through a new browser on a device. Sessions let you use Focus Talk without having to log in again for a time period specified by the system administrator. To end the session sooner, use the 'Log Out' button."
                    />
                </p>
                {content}
            </div>
